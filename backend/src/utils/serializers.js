...
function trackDto(track) {
  ...
  return {
    ...
    licenseConfirmed: Boolean(track.licenseConfirmed),
    licenseConfirmedAt: track.licenseConfirmedAt || null,
    aiRiskLevel: track.aiRiskLevel || "unknown",
    aiRiskReasons: Array.isArray(track.aiRiskReasons) ? track.aiRiskReasons : [],
    aiSuggestedAction: track.aiSuggestedAction || "unknown",
    aiAdminNote: track.aiAdminNote || "",
    aiRiskSource: track.aiRiskSource || "disabled",
    aiCheckedAt: track.aiCheckedAt || null,
